...
<link href="<?php echo e(asset('vendor/select2/css/select2-bootstrap5.min.css')); ?>" rel="stylesheet">
<style>
    .password-toggle {
        cursor: pointer;
    }
                    ...
                    <tbody>
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <?php if($user->role === 'wali' && $user->santri->count() > 0): ?>
                                        <ul class="list-unstyled mb-0">
                                            <?php $__currentLoopData = $user->santri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $santri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li>
                                                    <a href="<?php echo e(route('admin.santri.show', $santri)); ?>" class="text-decoration-none">
                                                        <?php echo e($santri->nama); ?> (<?php echo e($santri->nisn); ?>)
                                                    </a>
                                                </li>
...
$(document).ready(function() {
    ...
    $('#santri_ids').select2({
        ...
        ajax: {
            url: "<?php echo e(route('admin.users.searchSantri')); ?>",
            type: 'GET',
            dataType: 'json',
...
function appendSantriToList(id, text) {
    ...
    linkedSantriList.append(`
        <div class="list-group-item d-flex justify-content-between align-items-center" data-santri-id="${id}">
            <div>
                <a href="<?php echo e(route('admin.santri.show', '')); ?>/${id}" class="text-decoration-none">
                    ${text}
                </a>
            </div>
...
function resetForm() {
    ...
    url = "<?php echo e(route('admin.users.store')); ?>"; // Assign to global url variable
...
function editUser(id) {
    ...
    url = `<?php echo e(url('admin/users')); ?>/${id}`; // Assign to global url variable


    // Fetch user data
    fetch(`<?php echo e(url('admin/users')); ?>/${id}/get-data`)
        ...
        .then(data => {
            if (data.success) {
                ...
                if (user.role === 'wali') {
                    fetch(`<?php echo e(url('admin/users')); ?>/${id}/santri`)
                        .then(response => response.json())
                        .then(data => {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\SPP-JNJ\resources\views\admin\users\index.blade.php ENDPATH**/ ?>