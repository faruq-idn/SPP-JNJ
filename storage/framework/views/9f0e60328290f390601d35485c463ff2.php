...
<html lang="id">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg fixed-top">
            <div class="container">
                <a class="navbar-brand d-flex align-items-center" href="/">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" class="me-2">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="hero-image">
                            ...
                            <img src="<?php echo e(asset('images/hero-image.png')); ?>" alt="Hero Image" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start">
                        <p>&copy; <?php echo e(date('Y')); ?> Pesantren Jabal Nur Jadid. All rights reserved.</p>
                    </div>
        ...
        <!-- Bootstrap JS -->
        <script src="<?php echo e(asset('vendor/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script><script>
...
<?php /**PATH C:\laragon\www\SPP-JNJ\resources\views\welcome.blade.php ENDPATH**/ ?>