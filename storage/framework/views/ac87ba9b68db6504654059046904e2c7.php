<div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.santri.import')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    ...
                    <div class="d-grid">
                        <a href="<?php echo e(route('admin.santri.template.download')); ?>" class="btn btn-outline-primary">
...
<?php /**PATH C:\laragon\www\SPP-JNJ\resources\views/admin/santri/partials/modal-import.blade.php ENDPATH**/ ?>