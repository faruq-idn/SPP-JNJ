        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="pembayaran-info" style="display: none;">
                    ...
                    <div class="d-grid">
                        <button type="button" class="btn btn-danger" onclick="confirmDeletePembayaran()">
...
function showDetail(id, bulan, nominal, tahun, status, tanggal, metode) {
    ...
    // Set current values for delete function
...
function confirmDeletePembayaran() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: `/admin/pembayaran/${currentPembayaranId}`,
                method: 'DELETE',
                headers: {
...
$(document).ready(function() {
    ...
    $('#formPembayaran').on('submit', function(e) {
        ...
        $.ajax({
            url: `/admin/pembayaran/${pembayaranId}/verifikasi`,
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
