...
function initializeForm() {
    ...
    // Load Kategori options
            $.get('<?php echo e(route("admin.kategori.list")); ?>', function(data) {
...
$('#santriFormModal').on('show.bs.modal', function(event) {
    ...
    if (mode === 'edit') {
        ...
        $('#santriForm').attr('action', `<?php echo e(url('admin/santri')); ?>/${id}`);
        $('input[name="_method"]').val('PUT');
        
        // Load data
        $.get(`<?php echo e(url('admin/santri')); ?>/${id}/edit`, function(data) {
        ...
        $('#santriForm').attr('action', '<?php echo e(route("admin.santri.store")); ?>');
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\SPP-JNJ\resources\views\admin\santri\_form_modal.blade.php ENDPATH**/ ?>