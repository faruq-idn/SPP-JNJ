...
function verifikasiPembayaran(id) {
    ...
    form.action = `<?php echo e(url('admin/pembayaran')); ?>/${id}/verifikasi`;
    modal.show();
}
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\SPP-JNJ\resources\views\admin\pembayaran\show.blade.php ENDPATH**/ ?>