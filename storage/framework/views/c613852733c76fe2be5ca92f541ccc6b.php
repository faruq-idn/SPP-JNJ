...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="btn-group" role="group">
            <a href="<?php echo e(route('admin.laporan.pembayaran')); ?>" class="btn btn-primary">
                <i class="fas fa-money-bill me-1"></i> Pembayaran
            </a>
            <a href="<?php echo e(route('admin.laporan.tunggakan')); ?>" class="btn btn-warning">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\SPP-JNJ\resources\views\admin\laporan\index.blade.php ENDPATH**/ ?>