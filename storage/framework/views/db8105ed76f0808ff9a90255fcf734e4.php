<?php $__env->startPush('before-content'); ?>
...
unset($__errorArgs, $__bag); ?>"
                                id="nisn" name="nisn" value="<?php echo e(old('nisn')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                id="tanggal_lahir" name="tanggal_lahir" value="<?php echo e(old('tanggal_lahir')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                id="alamat" name="alamat" rows="3" required><?php echo e(old('alamat')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select <?php $__errorArgs = ['wali_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <?php $__currentLoopData = $wali; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($w->id); ?>" <?php echo e(old('wali_id') == $w->id ? 'selected' : ''); ?>>
                                        <?php echo e($w->name); ?>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <?php $__currentLoopData = $jenjang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($j); ?>" <?php echo e(old('jenjang') == $j ? 'selected' : ''); ?>>
                                        <?php echo e($j); ?>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <?php if(old('jenjang')): ?>
                                    <?php $__currentLoopData = $kelas[old('jenjang')] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($k); ?>" <?php echo e(old('kelas') == $k ? 'selected' : ''); ?>>
                                            <?php echo e($k); ?>
...
$(document).ready(function() {
    ...
    $('#jenjang').change(function() {
        ...
        var kelas = <?php echo json_encode($kelas, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\SPP-JNJ\resources\views\admin\santri\create.blade.php ENDPATH**/ ?>